...
LDLIBSOPTIONS=-L/usr/local/lib -lglfw3 -lGL -lGLU -lX11 -lXi -lXxf86vm -lXinerama -lXcursor -lXrandr -lpthread -lGLEW -lSOIL
...
${OBJECTDIR}/Shader.o: Shader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Shader.o Shader.cpp
